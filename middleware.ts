...
const publicApiRoutes = ['/api/auth', '/api/stripe/webhook', '/api/stripe/debug', '/api/stripe/check-subscription', '/api/stripe/sync-subscription', '/api/admin/migrate', '/api/orquesta', '/api/agent/diagnose']
