...
export default async function FundsPage() {
    ...
    return (
        <div className="space-y-6">
            <div>
                <h1 className="text-3xl font-bold text-white">Funds Catalog</h1>
                <p className="text-slate-400 mt-1">Browse available funds and start your application</p>
            </div>
            ...
            {funds && funds.length > 0 ? (
                ...
                <Card className="bg-slate-900 border-slate-800 border-dashed">
                    <CardContent className="flex flex-col items-center justify-center py-16">
                        ...
                        <CardTitle className="text-white mb-2">No funds available</CardTitle>
